...
function loadFilterConfig(configPath: string): FilterConfig {
  ...
  try {
    ...
    return {
      ...
      dev_team_hold_rate_max: parsed.filters?.dev_team_hold_rate_max ?? DEFAULT_FILTERS.dev_team_hold_rate_max,
      suspected_insider_hold_rate_max: parsed.filters?.suspected_insider_hold_rate_max ?? DEFAULT_FILTERS.suspected_insider_hold_rate_max,
      rat_trader_amount_rate_max: parsed.filters?.rat_trader_amount_rate_max ?? DEFAULT_FILTERS.rat_trader_amount_rate_max,
      bundler_trader_amount_rate_max: parsed.filters?.bundler_trader_amount_rate_max ?? DEFAULT_FILTERS.bundler_trader_amount_rate_max,
      sniper_count_max: parsed.filters?.sniper_count_max ?? DEFAULT_FILTERS.sniper_count_max,
      bot_degen_count_max: parsed.filters?.bot_degen_count_max ?? DEFAULT_FILTERS.bot_degen_count_max,
      smart_degen_count_min: parsed.filters?.smart_degen_count_min ?? DEFAULT_FILTERS.smart_degen_count_min,
      renowned_count_min: parsed.filters?.renowned_count_min ?? DEFAULT_FILTERS.renowned_count_min,
